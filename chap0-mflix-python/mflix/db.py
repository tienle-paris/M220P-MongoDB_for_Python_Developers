...
# Question : Chapter 4: Resiliency - Ticket: Connection Pooling
...
def get_db():
    ...
    if db is None:
        ...
        # Ref: https://mongodb.github.io/node-mongodb-native/3.1/api/MongoClient.html
...
# Question : Chapter 1: Driver Setup - Ticket: Projection
...
# Question : Chapter 2: User-Facing Backend - Ticket: Faceted Search
...
# Question : Chapter 1: Driver Setup - Ticket: Text and Subfield Search
# tests/test_text_and_subfield_search.py
...
# Question : Chapter 2: User-Facing Backend - Ticket: Paging
...
# Question : Chapter 2: User-Facing Backend - Ticket: Get Comments
# notebooks/basic_aggregation.ipynb
# tests/test_get_comments.py
# pytest -m get_comments
# python run.py

# Question : Chapter 4: Resiliency - Ticket: Handling Errors
# notebooks/error_handling.ipynb
...
# Question : Chapter 2: User-Facing Backend - Ticket: Create/Update Comments
...
# Question : Chapter 2: User-Facing Backend - Ticket: Delete Comments
...
to better understand the task.
"""
# Question : Chapter 2: User-Facing Backend - Ticket: User Management
# mflix/api/user.py
...
def add_user2(name, email, hashedpw):
    try:
...
# Question : Chapter 2: User-Facing Backend - Ticket: User Preferences
...
# Question : Chapter 3: Admin Backend - Ticket: User Report
